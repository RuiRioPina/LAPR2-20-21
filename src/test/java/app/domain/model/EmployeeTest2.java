...
assertNotEquals(e1.generateEmployeePassword().length(),notExpectedLength);
    ...
    public void toStringTest(){
      ...
      String expected1 = String.format("This employee is named Tiago Santa Cruz. Their ID is TSC00002. Their address is Porto. Their phone number is 999999999. %nTheir SOC is 1234. Their email address is tiagosantacruz@gmail.com. Their username is Tiago. Their password is "+e1.getPassword()+". Their role is Receptionist.");
      String notExpected1 = String.format("This employee is named Tiagos Santa Cruz. Their ID is TSC00002. Their address is Porto. Their phone number is 999999999. %nTheir SOC is 1234. Their email address is tiagosantacruz@gmail.com. Their username is Tiago. Their password is "+e1.getPassword()+". Their role is Receptionist.");
        String expected2 = String.format("This employee is named Tiago Santa Cruz. Their ID is TSC00002. Their address is Porto. Their phone number is 999999999. %nTheir SOC is 1234. Their email address is tiagosantacruz@gmail.com. Their username is Tiago. Their password is "+e2.getPassword()+". Their role is Receptionist. Their doctor Index number is 123456");
        String notExpected2 = String.format("This employee is named Tiago Santa Cruz. Their ID is TSC00002. Their address is Porto. Their phone number is 999999999. %nTheir SOC is 1234. Their email address is tiagosantacruz@gmail.com. Their username is Tiago. Their password is "+e1.getPassword()+". Their role is Receptionist.");
