...
public class NHSReport {
    ...
    public String getReportString(Calendar olderDate, Calendar newerDate, double aParameterSignificance, double aTestParameter, double bTestSignificance, double bTestParameter, double fTestSignificance, double confidenceIntervalSignificance) {
   ...
   // public static void main(String[] args) {
     ...
     //   double[]arrX2 = {1000, 215, 1070, 550, 480, 920, 1350, 325, 670, 1215};
      ...
      //  LinearRegression linearRegression = new LinearRegression(arrX1, arrY1);
       // NHSReport nhsReport = new NHSReport(linearRegression, arrY1, arrX2);
