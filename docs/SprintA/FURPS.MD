...
CPU usage: It needs an intermediate CPU usage to support the use of JavaFX and some minor calculations.

Application availability: Should be available at any time because it needs to calculate the test and other functionalities.
